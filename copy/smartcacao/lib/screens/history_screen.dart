...
class _HistoryScreenState extends State<HistoryScreen> {
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final filteredRecords = selectedFilter == 'All'
              ? records
              : records.where((r) => r.fermentationStatus == _getInternalStatusFromDisplay(selectedFilter)).toList();
  ...
  String _getInternalStatusFromDisplay(String displayStatus) {
    switch (displayStatus) {
      case 'Under-fermented':
        return 'under_fermented';
      case 'Over-fermented':
        return 'properly_fermented';
      case 'Properly Fermented':
        return 'over_fermented';
      default:
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildStatItem('Over', stats['properly_fermented'] ?? 0, Colors.amber),
              _buildStatItem('Proper', stats['over_fermented'] ?? 0, Colors.green),
            ],
          ),
        );
      },
